...
<%-- 글 작성 폼 --%>
<div class="container">
   <h4 align="center"><b>자유게시판 글 작성</b></h4>
   	<br />
	<hr />
   
   <div align="center">
   <form action ="freeWritePro.jsp" method="post" enctype="multipart/form-data" onsubmit="return checkField()">
   		   ...
   		   <br />
			   <table align="center">
			      <tr>
			         ...
			         <%if(id.equals("admin")){ %>
			         <td>         
			            <select name="boCategory" required>
			      ...
			      <tr>
			         <td>제목</td>
			         <td><input type="text" name="boSubject" required/><td>
			      </tr>
			      <tr>
			         <td>작성자</td>
					...
					<tr>
				         <td>내용</td>
				         <td><textarea wrap="hard" name="boContent" rows="10" cols="80" required></textarea> </td>
			       </tr>
			       <tr>
			          <td>파일첨부</td>
...
<script>
		...
		function checkField(){
			...
			if(volsd > voled){
				alert("봉사시작날짜가 봉사종료날짜보다 늦게 설정될 수 없습니다.");
				return false;
			}
		}//체크필드
	</script>
